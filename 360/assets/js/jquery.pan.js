...
jQuery.fn.extend({
	...
	pan: function (e) {
        ...
        console.log("height viewport" + vpH);

        if(h >= w){
            panImg.css("height",  '70%');
            panImg.css("top",  '50%');
            panImg.css("left",  '50%');
            panImg.css("transform",  ' translate(-50%, -50%)');
        }else{
            panImg.css("width",  '70%');
            panImg.css("top",  '50%');
            panImg.css("left",  '50%');
		...
		function panInit(event) {
            ...
            var windowsize = $(window).width();
                ...
                panImg.css("height",  'auto');
                panImg.css("transform",  ' translate(0%, 0%)');
